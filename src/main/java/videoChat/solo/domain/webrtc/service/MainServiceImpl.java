...
public class MainServiceImpl {
    ...
    private synchronized Map<String, Object> validationRoom(Map<String, Object> result, Room room, String sid, String uuid) {
