package videoChat.solo.domain.videoChat.service;
...
public class ChatServiceMain {
    ...
    public ChatServiceMain(MsgChatService msgChatService, RtcChatService rtcChatService, FileService fileService) {
        this.msgChatService = msgChatService;
