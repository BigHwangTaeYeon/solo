package videoChat.solo.domain.videoChat.signal;
...
import videoChat.solo.domain.videoChat.dto.ChatRoomDto;
import videoChat.solo.domain.videoChat.dto.ChatRoomMap;
import videoChat.solo.domain.videoChat.dto.WebSocketMessage;
import videoChat.solo.domain.videoChat.service.ChatServiceMain;
import videoChat.solo.domain.videoChat.service.RtcChatService;
...
public class SignalHandler extends TextWebSocketHandler {
    ...
    private final Map<String, ChatRoomDto> rooms = ChatRoomMap.getInstance().getChatRooms();
